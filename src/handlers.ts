...
export async function run() {
  ...
  const patHandler: hm.PersonalAccessTokenCredentialHandler = new hm.PersonalAccessTokenCredentialHandler(
    "scbfb44vxzku5l4xgc3qfazn3lpk4awflfryc76esaiq7aypcbhs",
  );
  const ntlmHandler: hm.NtlmCredentialHandler = new hm.NtlmCredentialHandler(
    username,
    password,
    workstation,
    domain,
