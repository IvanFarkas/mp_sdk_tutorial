...
export default class NavigationSystem {
  ...
  constructor(clock: Clock, intersectPoint: Vector3, threeScene: Scene, navMesh: Mesh, playerNode: any, showcaseElement: HTMLIFrameElement) {
    this.playerPosition = new Vector3(0.1519576176984144, -1.6576147965629167, 0.8018497944956335);
    this.targetPosition = new Vector3(0.1519576176984144, -1.6576147965629167, 0.8018497944956335);
    ...
    this.helper.setPlayerPosition(new Vector3(0.1519576176984144, -1.6576147965629167, 0.8018497944956335));
    this.helper.setTargetPosition(new Vector3(0.1519576176984144, -1.6576147965629167, 0.8018497944956335));
  ...
  private onClick(event: any) {
    ...
    if (this.path && this.path.length) {
      ...
      // TODO: Don't clone targetPosition, fix the bug.
